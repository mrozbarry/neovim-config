...
vim.keymap.set('n', '<C-f>', require('telescope.builtin').buffers, { desc = '[ ] Find existing buffers' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'php', 'javascript', 'typescript', 'vimdoc', 'vim' },
  ignore_install = {},
